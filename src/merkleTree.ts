...
/**
 * Find what the remote peer is missing from us (what we can send them)
 */
export function findWhatRemoteNeeds(ourNode: MerkleNode, theirNode?: MerkleNode): string[] {
 ...
 */
export function findWhatWeNeed(theirNode: MerkleNode, ourNode?: MerkleNode): string[] {
...
/**
 * Find which subtrees to request from peer
 */
export function findNeededSubtrees(localNode: MerkleNode, remoteNode?: MerkleNode): MerkleNode[] {
